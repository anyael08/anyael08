...
<head>
   ...
   <title>Regístrese como administrador</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpass" required placeholder="Confirmal Contraseña" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
